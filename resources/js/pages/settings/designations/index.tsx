            ...
            <div className="space-y-4">
                <div className="flex items-start justify-between gap-4">
                    <Heading
                        ...
                        description={t('Manage designation reference records')}
                    />
                    <Button asChild size="sm">
                        <Link href={DesignationController.create.url()}>
                                    ...
                                    <TableRow key={designation.id}>
                                        ...
                                        <TableCell className="w-0">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                >
                                                    <Link
                                                        href={DesignationController.edit.url(
                                                            designation.id,
                                                        )}
                                                    >
                                                ...
                                                <Form
                                                    {...DesignationController.destroy.form(
                                                        designation.id,
                                                    )}
                                                >
                                                    {({ processing }) => (
