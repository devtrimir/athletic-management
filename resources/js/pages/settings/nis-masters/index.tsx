...
export default function Index({ masters }: { masters: NisMaster[] }) {
    ...
    const filtered = useMemo(() => {
        ...
        return masters.filter((master) => {
            ...
            const matchesQuery =
                !q ||
                [master.code, master.name, master.short_name ?? ''].some(
            ...
            <div className="space-y-4">
                <div className="flex items-start justify-between gap-4">
                    <Heading
                        variant="small"
                        title={t('NIS Masters')}
                        description={t('Manage coach master references')}
                    />
                                    ...
                                    <TableRow key={master.id}>
                                        ...
                                        <TableCell className="w-0">
                                            <div className="flex items-center justify-end gap-1">
                                                ...
                                                >
                                                    <Link
                                                        href={NisMasterController.index.url()}
                                                    >
                                                        <Pencil className="h-4 w-4" />
                                                    </Link>
                                                </Button>
                                                <Form
                                                    {...NisMasterController.index.form()}
                                                >
                                                    {() => (
                                                        <Button
                                                            variant="ghost"
...
Index.layout = {
    breadcrumbs: [
        { title: 'NIS Masters', href: NisMasterController.index.url() },
    ],
};
