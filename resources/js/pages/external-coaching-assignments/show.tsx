            ...
            <div className="space-y-6">
                ...
                <div className="overflow-hidden rounded-xl border bg-card">
                    <div className="grid gap-5 p-6 sm:grid-cols-2 lg:grid-cols-3">
                        <Detail
                            label={t('Status')}
                            value={<Badge>{t(assignment.status)}</Badge>}
                        />
                        <Detail
                            label={t('Member PNO')}
                            value={assignment.member?.pno || t('Not set')}
                        />
                        <Detail
                            label={t('Coach')}
                            value={
                                assignment.external_coach?.name || t('Not set')
                            }
                        />
                        <Detail
                            label={t('Venue')}
                            value={
                                assignment.training_venue?.name || t('Not set')
                            }
                        />
                        <Detail
                            label={t('Sport')}
                            value={assignment.sport?.name || t('Not set')}
                        />
                        <Detail
                            label={t('Attendance mode')}
                            value={t(assignment.attendance_mode)}
                        />
                        <Detail
                            ...
                            value={
                                ...
                                assignment.training_end_time
                                    ? `${assignment.training_start_time} - ${assignment.training_end_time}`
                                    : t('Not set')
                            }
                        />
                        <Detail
                            ...
                            value={
                                assignment.training_days?.length
