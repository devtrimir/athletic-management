...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('coach_promotions', function (Blueprint $table) {
            ...
            $table->index(['coach_id', 'promotion_date']);
        });
    }
    ...
    {
        Schema::dropIfExists('coach_promotions');
    }
};
