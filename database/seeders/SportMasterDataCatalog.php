...
{
    /**
     * @return array<string, array{code: string, description: string, sort_order: int}>
     */
    public static function sports(): array
    {
        return [
            'एथलेटिक्स' => ['code' => 'ATHLETICS', 'description' => 'Track and field events including races, jumps, throws, and relays.', 'sort_order' => 10],
            'आर्चरी' => ['code' => 'ARCHERY', 'description' => 'Target archery events by bow type and distance.', 'sort_order' => 20],
            'शूटिंग' => ['code' => 'SHOOTING', 'description' => 'Precision shooting events across rifle, pistol, and shotgun.', 'sort_order' => 30],
            'योगा' => ['code' => 'YOGA', 'description' => 'Individual and team judged yoga events.', 'sort_order' => 40],
            'जिम्नास्टिक' => ['code' => 'GYMNASTICS', 'description' => 'Artistic, rhythmic, and trampoline gymnastics events.', 'sort_order' => 50],
            'साइकिलिंग' => ['code' => 'CYCLING', 'description' => 'Road and track cycling race events.', 'sort_order' => 60],
            'क्रॉस कंट्री' => ['code' => 'CROSS_COUNTRY', 'description' => 'Distance running over natural terrain.', 'sort_order' => 70],
            'पावर लिफ्टिंग' => ['code' => 'POWERLIFTING', 'description' => 'Strength events measured by lifted weight.', 'sort_order' => 80],
            'भारोत्तोलन' => ['code' => 'WEIGHTLIFTING', 'description' => 'Olympic weightlifting events measured by total lifted weight.', 'sort_order' => 90],
            'बॉडी बिल्डिंग' => ['code' => 'BODY_BUILDING', 'description' => 'Physique and body building judged categories.', 'sort_order' => 100],
            'बैडमिंटन' => ['code' => 'BADMINTON', 'description' => 'Singles, doubles, and mixed doubles racket events.', 'sort_order' => 110],
            'टेबल टेनिस' => ['code' => 'TABLE_TENNIS', 'description' => 'Singles, doubles, mixed doubles, and team racket events.', 'sort_order' => 120],
            'टेनिस' => ['code' => 'TENNIS', 'description' => 'Singles, doubles, mixed doubles, and team tennis events.', 'sort_order' => 130],
            'स्क्वैश' => ['code' => 'SQUASH', 'description' => 'Singles, doubles, and team squash events.', 'sort_order' => 140],
            'कुश्ती' => ['code' => 'WRESTLING', 'description' => 'Freestyle and Greco-Roman combat events by weight category.', 'sort_order' => 150],
            'वुशु' => ['code' => 'WUSHU', 'description' => 'Sanda combat and taolu form events.', 'sort_order' => 160],
            'ताईक्वांडो' => ['code' => 'TAEKWONDO', 'description' => 'Kyorugi combat and poomsae judged events.', 'sort_order' => 170],
            'जूडो' => ['code' => 'JUDO', 'description' => 'Combat events by weight category plus team events.', 'sort_order' => 180],
            'कराटे' => ['code' => 'KARATE', 'description' => 'Kumite combat and kata judged events.', 'sort_order' => 190],
            'बॉक्सिंग' => ['code' => 'BOXING', 'description' => 'Boxing bouts by weight category.', 'sort_order' => 200],
            'आर्म रेसलिंग' => ['code' => 'ARM_WRESTLING', 'description' => 'Left and right arm contests by weight category.', 'sort_order' => 210],
            'मलखम्भ' => ['code' => 'MALLAKHAMB', 'description' => 'Pole, rope, hanging, and team judged events.', 'sort_order' => 220],
            'फेंसिंग' => ['code' => 'FENCING', 'description' => 'Foil, epee, and sabre individual and team events.', 'sort_order' => 230],
            'हॉकी' => ['code' => 'HOCKEY', 'description' => 'Field hockey team match events.', 'sort_order' => 240],
            'कबड्डी' => ['code' => 'KABADDI', 'description' => 'Kabaddi team match events.', 'sort_order' => 250],
            'वॉलीबॉल' => ['code' => 'VOLLEYBALL', 'description' => 'Indoor and beach volleyball team events.', 'sort_order' => 260],
            'फुटबॉल' => ['code' => 'FOOTBALL', 'description' => 'Football team match events.', 'sort_order' => 270],
            'क्रिकेट' => ['code' => 'CRICKET', 'description' => 'Cricket team match formats.', 'sort_order' => 280],
            'बास्केटबॉल' => ['code' => 'BASKETBALL', 'description' => 'Basketball team match events.', 'sort_order' => 290],
            'हैंडबॉल' => ['code' => 'HANDBALL', 'description' => 'Handball team match events.', 'sort_order' => 300],
            'खो-खो' => ['code' => 'KHO_KHO', 'description' => 'Kho-kho team match events.', 'sort_order' => 310],
            'रस्साकशी' => ['code' => 'TUG_OF_WAR', 'description' => 'Team rope pulling events.', 'sort_order' => 320],
            'बॉल बैडमिंटन' => ['code' => 'BALL_BADMINTON', 'description' => 'Ball badminton team match events.', 'sort_order' => 330],
            'तैराकी' => ['code' => 'SWIMMING', 'description' => 'Pool race, relay, and medley events.', 'sort_order' => 340],
            'वाटर पोलो' => ['code' => 'WATER_POLO', 'description' => 'Water polo team match events.', 'sort_order' => 350],
            'डाइविंग' => ['code' => 'DIVING', 'description' => 'Springboard and platform diving events.', 'sort_order' => 360],
            'कयाकिंग व केनोइंग' => ['code' => 'KAYAKING_CANOEING', 'description' => 'Kayak and canoe sprint/slalom race events.', 'sort_order' => 370],
            'रोइंग' => ['code' => 'ROWING', 'description' => 'Sculls and sweep rowing crew events.', 'sort_order' => 380],
            'पेंचक सिलाट' => ['code' => 'PENCAK_SILAT', 'description' => 'Tanding combat and seni artistic events.', 'sort_order' => 390],
            'सेपक टकरा' => ['code' => 'SEPAK_TAKRAW', 'description' => 'Sepak takraw regu and team events.', 'sort_order' => 400],
            'वाटर स्पोर्ट्स' => ['code' => 'WATER_SPORTS', 'description' => 'Flexible umbrella category for water sport events not yet normalized separately.', 'sort_order' => 410],
        ];
    }
