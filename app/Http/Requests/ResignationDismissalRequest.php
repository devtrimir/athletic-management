...
class ResignationDismissalRequest extends ReportFilterRequest
{
    /**
    ...
    /**
     * @return array{session_id: int|null, sport_id: int|null, unit_id: int|null, tier_id: int|null, from_date: string|null, to_date: string|null, status: string|null}
     */
