...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('members/{member}/deletion-impact', [MemberController::class, 'deletionImpact'])->withTrashed()->name('members.deletion-impact');
    Route::get('members/check-pno', [MemberController::class, 'checkPno'])->name('members.check-pno');
    Route::post('members/{member}/restore', [MemberController::class, 'restore'])->withTrashed()->name('members.restore');
    Route::delete('members/{member}/force', [MemberController::class, 'forceDestroy'])->withTrashed()->name('members.force-destroy');
    Route::resource('members', MemberController::class)->withTrashed(['show']);
    Route::get('members/{member}/teams', [MemberProfileTabController::class, 'teams'])->withTrashed()->name('members.teams');
    Route::get('members/{member}/events', [MemberProfileTabController::class, 'events'])->withTrashed()->name('members.events');
    Route::get('members/{member}/performance', [MemberProfileTabController::class, 'performance'])->withTrashed()->name('members.performance');
    Route::get('members/{member}/external-coaching', [MemberProfileTabController::class, 'externalCoaching'])->withTrashed()->name('members.external-coaching');
    Route::get('members/{member}/special-achievements', [MemberProfileTabController::class, 'specialAchievements'])->withTrashed()->name('members.special-achievements');
    Route::get('members/{member}/promotions', [MemberProfileTabController::class, 'promotions'])->withTrashed()->name('members.promotions');
    Route::get('members/{member}/changelog', [MemberProfileTabController::class, 'changelog'])->withTrashed()->name('members.changelog');
    Route::get('members/{member}/media', [MemberProfileTabController::class, 'media'])->withTrashed()->name('members.media');
    Route::get('members/{member}/status', [MemberProfileTabController::class, 'status'])->withTrashed()->name('members.status');
    Route::get('members/{member}/preview', [MemberController::class, 'preview'])->withTrashed()->name('members.preview');
    ...
    Route::get('coaches/{coach}/special-achievements', [CoachProfileTabController::class, 'specialAchievements'])->name('coaches.special-achievements');
    Route::post('coaches/{coach}/special-achievements', [CoachSpecialAchievementController::class, 'store'])->name('coaches.special-achievements.store');
    Route::patch('coaches/{coach}/special-achievements/{specialAchievement}', [CoachSpecialAchievementController::class, 'update'])->name('coaches.special-achievements.update');
