...
- [ ] **P6-T39** Coach playing-career achievements (standalone table, isolated from all medal tallies) with CRUD section in Achievements tab; special + playing achievements wired into print preview and quick view — PR #192
