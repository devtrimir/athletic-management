...
- [ ] **P6-T38** Coach special achievements: standalone `coach_special_achievements` table (separate from member), CRUD + private order document (upload/preview modal/download), route-backed tab on coach profile, RBAC permission, audit wiring, en+hi keys — PR #191
