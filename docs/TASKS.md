...
- [~] **P6-T47** Fix team-event participation media not appearing on member media tab; one participation per team with `lineup_member_ids`; participant candidate list excludes already-lined-up members
